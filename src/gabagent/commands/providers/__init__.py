...
from gabagent.commands.providers.moviescout import PROVIDER as _moviescout
...
PROVIDERS: list[CapabilityProvider] = [_jellyfin, _radarr, _sonarr, _moviescout, _tidal, _mpris, _system,
                                       _applaunch, _desktop, _timer, _voice_control]
